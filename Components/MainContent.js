    ...
    <div className="searchBox">
        ...
        <div>
            ...
            <div className="searchResultBtn">
                <button onClick={() => {props.renderMain(!props.initMain); props.renderRestComponent(!props.initRestaurant)}} >Show all places(47)</button> 
                <button >Show by food category (13)</button>
            </div>}
    </div>
    ) 
}
